...
> - **However** if we can extract the *market sentiment* from *news* then we might be able to do better 

*This is what this course is about (and in practice a lot of applied NLP, which is broadly useful)*
...
- **Course content:**
  ...
  + Bathtub: Advanced $\rightarrow$ Basics $\rightarrow$ Advanced
]
