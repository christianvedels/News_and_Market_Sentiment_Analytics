...
def ZipfIt(textID):
    ...
    file_path = f'Lecture 2 - Data wrangling with text/Coding_challenge_data/Texts/Text{textID}.txt'
    ...
    slope, _, _, _, _ = linregress(log_rank, log_freq)
...
if __name__ == "__main__":
    ...
    plt.savefig("Lecture 2 - Data wrangling with text/Coding_challenge_histogram.png")

    # Classify based on slope and test quality
    # Load answers for testing accuracy
    answers = pd.read_csv('Lecture 2 - Data wrangling with text/Coding_challenge_data/Answer.csv')
